...
@CucumberOptions(features = "src/test/resources/features/AddEmployee.feature" , //set: Path to the Feature Files
				 ...
				 tags = "@regression", //instruct: What tags in feature files should be executed
