...
public class GenerateTokenSteps {
	...
	public void a_JWT_is_generated() {
		...
		RequestSpecification generateTokenRequest =	APICommonMethods.generateTokenRequest(CommonMethods.readJson(APIConstans.GENERATE_TOKEN_JSON));
		
		/** Storing response into generateTokenResponse */
		Response generateTokenResponse = generateTokenRequest.when().post(APIConstans.GENERATE_TOKEN_URI);
